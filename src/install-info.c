...
/* this is a slightly modified util/install-info.c from texinfo 3.12.
 * I distribute this with xzgv to avoid requiring people to have texinfo
 * installed just to get their `dir' file updated.
 *
 * my changes:
 * - removed zlib stuff (less hassle to wrap with gzip invocations if needed)
 * - removed locale and internationalisation stuff
 * - added headers to avoid needing `system.h'
 * - added a couple of prototypes so it's ok with -Wall.
 *
 * 1999-02-04: added #include <errno.h>.
 *
 * -Rus.
 */
